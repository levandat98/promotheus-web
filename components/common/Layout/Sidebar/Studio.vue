      ...
      <ul class="overflow-x-hidden overflow-auto flex flex-col">
        ...
        >
          <ul class="duration-300">
            <StudioSidebarItem
              v-for="component in studioSidebar.items"
...
import StudioSidebarItem from './StudioSidebarItem.vue'
import { studioSidebar } from '~/constants/config/base/studioSidebar'
export default {
  name: 'Sidebar',
  components: {
    StudioSidebarItem,
